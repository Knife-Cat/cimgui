...
//based on imgui.h file version "1.92.0 WIP" 19193 from Dear ImGui https://github.com/ocornut/imgui
...
typedef void (*ImAssertFunc)(bool, const char*);
typedef enum {
...
CIMGUI_API void igSetAssertFunc(ImAssertFunc func);
